...
def create_document_config(
    ...
    if metadata:
        if isinstance(metadata, list):
            ...
            if 'bucketOwnerAccountId' in document['metadata']['s3Location'] and document['metadata']['s3Location'][
                'bucketOwnerAccountId'] is None:
                                        ...
                                        if start_idx >= 0 and end_idx > 0:
                                            ...
                                            if 'shot_index' in shot_json and 'start_timestamp_millis' in shot_json:
                                                ...
                                                if timestamp['start_time'] is not None and not any(
                                                        ts['shot_index'] == timestamp['shot_index'] for ts in
                    ...
                    if hasattr(doc, 'page_content'):
                        ...
                        try:
                            ...
                            if content.strip().startswith('{'):
                                ...
                                if all(key in json_obj for key in
                                       ['start_timestamp_millis', 'end_timestamp_millis', 'segment_index', 'type',
                                        'text']):
